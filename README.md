<p align="center">
  <img src="./packages/overlock/assets/logo.svg" alt="overlock logo" width="180" />
</p>
...
<p align="center">
  ...
  <a href="packages/overlock/package.json"><img src="https://img.shields.io/badge/dependencies-0-44cc11" alt="Zero runtime dependencies" /></a>
  <a href="packages/overlock/vitest.config.ts"><img src="https://img.shields.io/badge/line%20coverage%20threshold-95%25%20per%20file-44cc11" alt="Line coverage threshold: 95% per file" /></a>
</p>
...
There are no LLM calls, no network calls and no telemetry, and the published
package has zero runtime dependencies, so `npx overlock` on a cold cache is a
...
- [Rules](#rules)
- [How findings are graded](#how-findings-are-graded)
- [Renames and reformatting](#renames-and-reformatting)
...
- [Handling of untrusted input](#handling-of-untrusted-input)
- [Scope](#scope)
