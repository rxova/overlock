...
describe('firstSentence', () => {
  ...
  it('collapses a link to its text', () => {
    const body = 'It grades every [deleted file](../rules/test-removed.md#deleted) on recovery.';
...
describe('renderMarkdown', () => {
  ...
  it('quotes a title containing a colon, which would otherwise break the YAML', () => {
    expect(
      renderMarkdown({ ...page, title: 'Grading: how a finding gets its severity' }),
    ).toContain('title: "Grading: how a finding gets its severity"');
  });
});
