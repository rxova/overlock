 ...
 *
 * `../rules/test-removed.md` written in `learn/severity.md` means the source
 * file `rules/test-removed.md`, and that file's twin is served at
 * `/rules/test-removed.md` — the twin route *is* the source path, because
