...
- [#34](https://github.com/rxova/overlock/pull/34) [`0c52246`](https://github.com/rxova/overlock/commit/0c522463364db174f8369ad928c061b3de0b0337) Thanks [@jonatankruszewski](https://github.com/jonatankruszewski)! - Add `--stage-record`, so the commit being built carries the record of the run that judged it.
...
- [#31](https://github.com/rxova/overlock/pull/31) [`57da3ea`](https://github.com/rxova/overlock/commit/57da3ea7a871a5c48e5734e5f9d1cd89b7f496ec) Thanks [@jonatankruszewski](https://github.com/jonatankruszewski)! - Stop the Claude Code hook raising the same self-suppression twice. A directive
